...
public class BarcodeViewDialog extends RotateDialog
{
	...
	public BarcodeViewDialog(Context context, Barcode barcode)
	{
		...
		Window window = CameraScreenActivity.getInstance().getWindow();
		window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);

		// inflate and adjust layout
		LayoutInflater inflater = (LayoutInflater) CameraScreenActivity.getInstance().getSystemService(
	...
	private void initControls()
	{
		Result result = new Result(barcode.getData(), null, null, BarcodeFormat.valueOf(barcode.getFormat()), barcode
				.getDate().getTime());
		ResultHandler resultHandler = ResultHandlerFactory.makeResultHandler(CameraScreenActivity.getInstance(), result);
