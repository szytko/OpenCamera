...
public class HistogramVFPlugin extends PluginViewfinder
{
	...
	public void onCreate()
	{
		...
		this.histogram = new HistogramView(CameraScreenActivity.getMainContext());
		...
		this.histogramRGB = new HistogramRGBView(CameraScreenActivity.getMainContext());
	...
	public void onClickHistogram(boolean isRGB)
	{
		...
		histoHeight = (int) (CameraScreenActivity.getGUIManager().getMaxPluginViewHeight() * 0.6);
		histoWidth = (int) (CameraScreenActivity.getGUIManager().getMaxPluginViewWidth() * 0.6);
		...
		if (isRGB)
		{
			CameraScreenActivity.getGUIManager().removeViewQuick(HistogramVFPlugin.this.histogramRGB);
			CameraScreenActivity.getGUIManager().addViewQuick(HistogramVFPlugin.this.histogram,
					PluginViewfinder.ViewfinderZone.VIEWFINDER_ZONE_BOTTOM_LEFT);
		} else
		{
			CameraScreenActivity.getGUIManager().removeViewQuick(HistogramVFPlugin.this.histogram);
			CameraScreenActivity.getGUIManager().addViewQuick(HistogramVFPlugin.this.histogramRGB,
					PluginViewfinder.ViewfinderZone.VIEWFINDER_ZONE_BOTTOM_LEFT);
		}
		editor.commit();
		UpdatePreferences();
