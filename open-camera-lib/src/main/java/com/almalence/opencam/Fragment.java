...
public class Fragment extends PreferenceFragment implements OnSharedPreferenceChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (aboutPref != null)
			aboutPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
			{
				...
				{
					Toast.makeText(CameraScreenActivity.getInstance(),
							CameraScreenActivity.getAppResources().getString(R.string.Pref_About), Toast.LENGTH_LONG)
							.show();
		...
		if (helpPref != null)
			helpPref.setOnPreferenceClickListener(new OnPreferenceClickListener()
			{
				public boolean onPreferenceClick(Preference preference)
				{
					...
					{
						SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(CameraScreenActivity
								.getMainContext());
		...
		if (saveToPreference != null)
			saveToPreference.setOnPreferenceChangeListener(new OnPreferenceChangeListener()
			{
				...
				public boolean onPreferenceChange(Preference preference, Object newValue)
				{
					...
					{
						Toast.makeText(
								CameraScreenActivity.getInstance(),
								CameraScreenActivity.getAppResources()
					...
					if (v == 2)
					{
					    ...
					    */
                        Toast.makeText(CameraScreenActivity.getInstance(), "FolderPicker was needed", Toast.LENGTH_LONG).show();
					}
	...
	private void initExportName(Preference preference, Object newValue)
	{
		...
		{
			String[] names = CameraScreenActivity.getAppResources().getStringArray(R.array.exportNameArray);
