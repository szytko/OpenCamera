...
public abstract class Plugin
{
	...
	public void selectImageDimension()
	{
		...
		try
		{
			prefIdx = Integer.parseInt(CameraScreenActivity.getImageSizeIndex());
	...
	public void setCameraPreviewSize()
	{
		...
		CameraScreenActivity.setPreviewWidth(os.getWidth());
		CameraScreenActivity.setPreviewHeight(os.getHeight());
	}
	...
	public void setupCameraParameters()
	{
		...
		int jpegQuality = Integer.parseInt(prefs.getString(CameraScreenActivity.sJPEGQualityPref, "95"));
